...
String HTMLProvider::getConfigHtml(String message, String dummyPassword)
{
  return
    ...
    "          Button:<br/><input type=\"number\" class=\"form-control\" name=\"customButtonGpio\" value=\"" + _settings->customButtonGpio + "\"><br/>"
    "          Button:<br/><input type=\"number\" class=\"form-control\" name=\"customRelayGpio\" value=\"" + _settings->customRelayGpio + "\"><br/>"
    "        </fieldset>"
    "        <fieldset class=\"form-group\">"
